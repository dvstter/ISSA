...
from piegtrain import make_agent, Workspace as piegWorkspace
  ...
  def train(self):
    ...
    while train_until_step(self.global_step):
      ...
      if not train_util_pure_vision(self.global_step) and not mode_pure_vision:
        ...
        self.agent.change_mode_pure_vision()
...
@hydra.main(version_base=None, config_path='cfgs', config_name='ctconfig')
def main(cfg):
  from cttrain import Workspace as W
  root_dir = Path.cwd()
  workspace = W(cfg)
